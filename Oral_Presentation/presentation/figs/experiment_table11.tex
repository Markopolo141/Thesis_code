...
\caption[Utility payments under LMP for 90 bus network]{Post payment utility under LMP against generation/consumption capacity (x, positive being generation) with per-unit utility (y)}
