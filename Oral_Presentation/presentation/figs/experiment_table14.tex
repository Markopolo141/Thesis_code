...
\caption[Utility payments under M-GNK for 90 bus network]{Post payment utility under proxy GNK against generation/consumption capacity (x, positive being generation) with per-unit utility (y)}
