...
Since }\DIFdelend \DIFaddbegin \DIFadd{, since }\DIFaddend the aggregated population mean estimate does not itself have a sample variance \DIFdelbegin \DIFdel{, }\DIFdelend but only the strata have means and sample variances.
Such EBBs can be applied as a bound for the mean of an individual stratum \DIFdelbegin \DIFdel{, }\DIFdelend but such an EBB cannot bind the aggregation of the mean estimates of all the strata.
