...
\DIFdelend \DIFaddbegin \section{\DIFadd{Conclusion and Summary: applications of a multidimensional extension}}\DIFaddend \label{sec:multi}
...
\subsection{\DIFadd{Chapter Summary}}
...
\DIFadd{Our resulting concentration inequality (SEBB) gives an analytic bound on the error of the stratified mean and explicitly considers the sample variances, data widths, sample numbers, and any additional weights on the strata; and includes factors specifically for strata sampled with and/or without replacement.
