...
Using this algorithm we considered networks which were randomly generated to have 10 nodes with 12 lines between them, \DIFdelbegin \DIFdel{and thus }\DIFdelend \DIFaddbegin \DIFadd{which was sufficiently }\DIFaddend small enough for it to be possible to solve the GNK value exactly.
...
\section{\DIFadd{Sampling a modified GNK value (M-GNK) at scale}}\DIFaddend \label{sec:modified_gnk}
