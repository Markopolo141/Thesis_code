...
\item \textsc{SEBM*-W} (Stratified empirical Bernstein method with variance assistance): the method of iteratively choosing samples \textit{with} replacement from strata to minimize Equation~\eqref{eq1}.
