...
In this context the sum of utility is straightforwardly one of many examples of a `collective utility function', a function that aggregates the utility of individuals and is a possible target for moral decision making.\cite{TheoriesofValueAggregation}

By contrast, egalitarian intuitions might be satisfied by moral decision making that affords equal utility for all individuals - and in some contexts this may be appropriate, even though it might not maximise the sum of utility; and this could be constructed as an alternative collective utility function.
