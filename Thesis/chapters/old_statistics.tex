...
Hence these new sampling methodologies will be variance sensitive and also possible to conduct in a single step, rather than two steps - as is necessary in Neyman sampling.

\subsection{Stratified sampling via EBBs and sequential unions}\label{section:unionising_ebbs}

To create a bound for the error of a stratified mean estimator from EBBs it is necessary to use probability unions to bind them together.
