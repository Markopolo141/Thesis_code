...
%The VCG solution builds upon the idea that the value of a player should be in reference to their 'absence' only at the solution point of the grand coalition, and therefore cannot allocate resources to those who do not interact with such a solution point; and a similar dynamic is present in LMP, in terms of marginal interaction.
