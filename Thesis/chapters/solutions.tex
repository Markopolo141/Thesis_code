...
But generally, mechanism design analyses systems which select a social outcome bassed apon the interaction of multiple parties with divergent interests.% and where each party has actual preferences over the possible outcomes, and also reported preferences over the outcomes.
...
Unfortunately, it is often the case that the nash-equilibria between strategising agents that have divergent interests, may not correspond with what is socially optimal. And so for instance, there are a series of strong impossibility proofs in mechanism design.
