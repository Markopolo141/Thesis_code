...
A secondary question is thus, how likely are envy-free allocation mechanisms likely to perform under strategising agents, and then in such conditions as may be present in electricity contexts.

Another dimension is which specific conceptiion of envy-freeness is most appropriate in practice. So for instance, should allocation optimise envy-relations between all consumers or between local consumers (such as graph envy-free conditions - see Section \ref{The concept of envy-freeness}), or how should envy-relations be considered between resource bundles and consumer which cannot feasibly consume them (perhaps motiving consideration of `meta envy-freeness' \cite{10.1007/978-3-642-15155-2_44}), should measures be envy-free or only envy-minimising, and at what cost to social or utilitarian efficiency.
