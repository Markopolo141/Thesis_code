...
Notwithstanding these considerations, LMP has particular advantages such as its ability to be computed and its linkage to economically relevant rationale, that means that it is actually implemented over other schemes in practice. \citep{zonal}
