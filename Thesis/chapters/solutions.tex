...
but the difficulty does not nessisarily receed even if monetary compensations between parties are included. such as per the Myerson-Satterthwaite theorem.
And similarly it is also proven that there is no easy alternative to VCG which is incentive compatabile, has unrestricted player preferences, and has individual rationality, and implements a socially optimal outcome.\cite{YI201679}

The field of Mechanism Design is an evolving field, and there are several ways of getting navigating around some of these impossibilities.

\subsection{Navigating around impossibilities of Mechanism Design}
