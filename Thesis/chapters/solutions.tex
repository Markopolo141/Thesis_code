...
This mechanism is the subject of a patent in the US \ref{Boi_faltings_patent}, and constitutes a budget balanced VCG-type mechanism.
which can be made a little bit more regular by randomly selecting the `sink', and splitting the budget surplus between the parties evenly without knowledge of who will be selected.\cite{10.1007/978-3-642-25510-6_14}
