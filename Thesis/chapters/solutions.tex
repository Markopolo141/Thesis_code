...
Indeed the Core may be empty, and in this case no solution can posses the same kind of desirable stability, however there are alternative allocations that minimise this shortcomming.
