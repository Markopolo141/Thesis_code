...
Additionally the application of our multi-dimensional extension of the SEBB (per section \ref{sec:multi}) to such tasks as neural network minibatch smart sampling, could be quite rewarding.
