...
\item	In the second section \ref{section:old_statistics}, of this chapter we show how EBBs can be bound together to create concentration inequalities appropriate for Stratified Sampling.
...
\item	In the fourth section \ref{section:SEBB}, we develop a second concentration inequality, which is a multi-part derivation of a complicated concentration inequality specifically tailored for the purposes of stratified sampling.
