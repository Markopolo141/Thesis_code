...
To begin the derivation of our new concentration inequality for stratified random sampling, we utilise and build upon some of the results of the previous section.
...
However the useful part here is to simplify thoes same upper bounds on the moment generating function into an exponential of a quadratic. as we will see.
