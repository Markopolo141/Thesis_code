...
Even in the context of linear utility functions and linear constraints, \eqref{knvalue1} forms a linear bilevel program (LBP) and is known to be NP-hard \cite{DBLP:journals/tec/SinhaMD18,Ben-Ayed:1990:CDB}.
...
The particular details of how our bilevel program can be reformulated and then solved as KKT conditions is as follows:
