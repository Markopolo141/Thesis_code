...
def setup(ppc):
	...
	mod_bilevel_solver.setup_solver(le_constraints,eq_constraints,[],costs)
...
def calc_maxmin_minmax(i):
	...
	#	mod_bilevel_solver.spruik()
	#	pass
	return mod_bilevel_solver.solve(break_down(i))


def spruik_solver():
	return mod_bilevel_solver.spruik()
